...
<li class="nav-item {{ Request::is('attributeValues*') ? 'active' : '' }}">
    <a class="nav-link" href="{!! route('attributeValues.index') !!}"><i class="nav-icon icon-cursor"></i><span>AttributeValues</span></a>
</li>
